# Powerful Wizard Auto Clicker v2.7.5
...
- 🐛 **Sequence button crash fix**: Opening the Sequence Configurator no longer crashes when run-time controls load
- ⏱️ **Safe UI initialization**: Run-time input handlers are suspended until all controls are wired up during window load
